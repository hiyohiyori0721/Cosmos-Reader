...
# 用法: powershell -ExecutionPolicy Bypass -File make-test-epub.ps1
$ErrorActionPreference = 'Stop'

$outDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$outPath = Join-Path $outDir 'sample.epub'
...
function Add-ZipEntry($path, $content, [bool]$compress = $true) {
  if ($compress) {
...
# mimetype 必须第一个且不压缩
Add-ZipEntry 'mimetype' "application/epub+zip`n" $false

Add-ZipEntry 'META-INF/container.xml' @'
...
Add-ZipEntry 'OEBPS/content.opf' @'
<?xml version="1.0" encoding="UTF-8"?>
...
Add-ZipEntry 'OEBPS/style.css' @'
body { font-family: "Georgia", "Songti SC", serif; line-height: 1.8; }
h1 { color: #a97832; margin-bottom: 0.8em; }
h2 { color: #8a6d3b; }
p { margin: 1em 0; text-indent: 2em; }
'@

Add-ZipEntry 'OEBPS/chapter1.xhtml' @'
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE html>
...
Add-ZipEntry 'OEBPS/chapter2.xhtml' @'
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
...
Add-ZipEntry 'OEBPS/chapter3.xhtml' @'
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
...
$zip.Dispose()
Write-Host "已生成测试书籍: $outPath ($((Get-Item $outPath).Length) bytes)"
