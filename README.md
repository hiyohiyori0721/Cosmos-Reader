...
- **划线**：选中文字后弹出划线条（黄 / 绿 / 蓝），点 🚫 清除；也可在「书签与笔记」面板管理
- **沉浸模式**：阅读时点击屏幕中央区域收起上下栏，再点一次恢复
